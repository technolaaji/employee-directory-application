    ...
    [5],
    {
                ...
                (t.default = function(e) {
                    function t(t) {
                        return o.default.createElement(
                            e,
                            (0, a.default)({ router: (0, u.useRouter)() }, t)
                        );
                    }
                    ...
                    function e() {
                        ...
                        n(this, e),
                            (this.updateHead = function(e) {
                                var r = (t.updatePromise = u.default
                                    .resolve()
                                    .then(function() {
                                        r === t.updatePromise &&
                                ...
                                value: function(e, t) {
                                    ...
                                    var c = t.map(s).filter(function(e) {
                                        for (
                                            ...
                                            if (o[t].isEqualNode(e))
                                                return o.splice(t, 1), !1;
                                        }
                                        return !0;
                                    });
                    ...
                    o(e, [
                        {
                            key: 'getDependencies',
                            value: function(e) {
                                return this.promisedBuildManifest.then(function(
                                    t
                                ) {
                                    return (
                                        (t[e] &&
            ...
            var x = (function() {
                function e(t, r, n, a) {
                    ...
                    c(this, e),
                        ...
                        (this.query = r),
                        (this.asPath =
                            m.isDynamicRoute(t) && __NEXT_DATA__.autoExport
                                ? t
                                : n),
                        (this.sub = h),
                        (this.clc = null),
                        ...
                        [
                            {
                                ...
                                value: function(e, t) {
                                    ...
                                    var a = i({}, n, { Component: r });
                                    (this.components[e] = a),
                                        '/_app' !== e
                                            ? e === this.route && this.notify(a)
                                            : this.notify(
                                                  this.components[this.route]
                                              );
                                },
                            ...
                            },
                            {
                                ...
                                value: function(t, r, n, a) {
                                    ...
                                    return new u(function(u, c) {
                                        ...
                                        var s =
                                                'object' === typeof r
                                                    ? d.formatWithValidation(r)
                                                    : r,
                                            f =
                                                'object' === typeof n
                                                    ? d.formatWithValidation(n)
                                                    : n;
                                        if (
                                            (o.abortComponentLoad(f),
                                            !a._h && o.onlyAHashChange(f))
                                        )
                                            return (
                                                (o.asPath = f),
                                                e.events.emit(
                                        ...
                                        var _ = w(h),
                                            E = a.shallow,
                                            k = void 0 !== E && E;
                                        if (m.isDynamicRoute(_)) {
                                            var C = p.parse(f).pathname,
                                                b = y.getRouteRegex(_),
                                                R = g.getRouteMatcher(b)(C);
                                            if (!R) {
                                                return (
                                                    console.error(
                                        ...
                                        e.events.emit('routeChangeStart', f),
                                            o
                                                ...
                                                .then(function(r) {
                                                    ...
                                                    var c = window.location.hash.substring(
                                                        1
                                                    );
                                                    if (
                                                        (o.set(
                                ...
                                value: function(e, t, r, n) {
                                    var a = this,
                                        o =
                                            ...
                                            arguments[4],
                                        i = this.components[e];
                                    return o && i && this.route === e
                                        ? u.resolve(i)
                                        : new u(function(t, r) {
                                              if (i) return t(i);
                                              a.fetchComponent(e).then(function(
                                                  e
                                              ) {
        ...
        fLxa: function(e, t, r) {
            ...
            var M = A.props,
                ...
                H = A.runtimeConfig,
                L = A.dynamicIds,
                V = JSON.parse(window.__NEXT_DATA__.dataManager),
                U = new R.DataManager(V);
            t.dataManager = U;
            var j = D || '';
            (r.p = j + '/_next/'),
                E.setConfig({
            ...
            window.__NEXT_P && window.__NEXT_P.map(F),
                (window.__NEXT_P = []),
                                ...
                                for (;;)
                                    switch ((e.prev = e.next)) {
                                        ...
                                        case 23:
                                            ...
                                            return (
                                                (e.next = 26),
                                                window.__NEXT_PRELOADREADY(L)
                                            );
                                        case 26:
                                            return (
                                                (t.router = X = (0,
                                                y.createRouter)(N, I, B, {
                                                    initialProps: M,
                                                    pageLoader: q,
                                                    App: W,
                                                    Component: z,
            ...
            function se(e) {
                ...
                return v.default.createElement(
                    ...
                    {
                        fn: function(e) {
                            return ne({ App: W, err: e }).catch(function(e) {
                    ...
                    v.default.createElement(
                        ...
                        { value: (0, y.makePublicRouterInstance)(X) },
                        v.default.createElement(
        ...
        r6lC: function(e, t, r) {
            ...
            var n,
                ...
                w = (e.exports = r('VX2v')('WeakMap', g, y, s, !0, !0));
            p &&
                h &&
        ...
        'uMC/': function(e, t, r) {
            var n = r('ADe/'),
                a = r('VJcA');
            e.exports = r('TaGV').getIterator = function(e) {
                var t = a(e);
        ...
        xGJO: function(e, t, r) {
            r('rgc3'), (e.exports = r('TaGV').Reflect.construct);
        },
        zVA4: function(e, t, r) {
            var n = r('/6KZ');
            n(n.P + n.R, 'Map', { toJSON: r('BGbK')('Map') });
        },
        zWrT: function(e, t, r) {
            var n = r('T/1i'),
                a = r('0HwX').f;
            r('qNvu')('getOwnPropertyDescriptor', function() {
                return function(e, t) {
                    return a(n(e), t);
                };
            });
